...
// $domain = 'http://localhost/kenzotrans.web.id/';
$domain = 'https://kenzotrans.web.id/';
$brand = 'Kenzo Trans';
    ...
    <section class="container my-20" id="rute-travel">
      <div class="">
        <div class="text-center inner-container">
          ...
          <p class="desc">
            <?= $brand ?> menawarkan travel reguler, trip/city tour hiace, sewa hiace, carter drop hiace jabodetabek, carter drop hiace nikahan.
          </p>
        </div>
        <div
            ...
            <?php foreach ($rute as $item) : ?>
              <div class="">
                <a
                  ...
                  class=""></a>
                <img
                  src="<?= $domain . 'src/img/rute-kenzo.jpg' ?>"
                  width="100%"
                  height="100%"
                  alt="<?= 'rute ' . $item ?>"
                  class="" />
          ...
          <div class="col-span-full md:col-span-6">
            <div class="text inner-container">
              ...
              <p class="desc !text-slate-300 !mb-5">
                <strong><?= $brand ?></strong> akan membantu anda melakukan perjalanan <a href="https://jasatravel.web.id" target="_blank" class="underline">travel</a> ke berbagai daerah, tentunya dengan harga murah dan terjangkau. Pelayanan yang diberikan sangat memuaskan. Selain travel reguler, kami juga menawarkan berbagai jasa sebagai berikut:
              </p>
